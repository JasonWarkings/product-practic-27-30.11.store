  ...
  <div class="container">
    <div class="row mt-4">
        ...
        <table class="table">
          ...
          <tbody>
            <tr v-for="(product, index) in cartStore.cartList" :key="product.productId">
              ...
              <td>
                <button type="button" class="btn btn-primary" @click="$router.push('/detail/' + product.productId)">Buy</button>
                <button type="button" class="btn btn-outline-danger" @click="cartStore.removeById(product.productId)">Delete</button>
              </td>
            </tr>
          </tbody>
        </table>
      ...
      <div class="col-md-10 text-end">
        <button type="button" class="btn btn-outline-success btn-lg me-2" @click="$router.push('/checkout')">Buy</button>
      </div>
      <div class="col-md-2">
